...
Blencowe H, Krasevec J, de Onis M, et al. National, regional, and worldwide estimates of low birthweight in 2015, with trends from 2000: A systematic analysis. The Lancet Global Health. 2019;7(7). doi:10.1016/s2214-109x(18)30565-5 
...
FAS_cat_None = Family affluence score
hs_contactfam_3cat_num_None = social capital: family friends
hs_participation_3cat_None = social capital: structural
...
studydata_clean <- studydata %>%
  select(c("e3_bw", "e3_alcpreg_yn_None", "h_age_None", "hs_wgtgain_None", "h_folic_t1_None", "h_mbmi_None", "e3_sex_None", "e3_gac_None", "FAS_cat_None", "hs_contactfam_3cat_num_None", "hs_participation_3cat_None")) %>%
...
ps.model.logit <- glm(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None + FAS_cat_None + hs_contactfam_3cat_num_None + hs_participation_3cat_None, 
...
for (ntree in tree.num){
 set.seed(100)
  rf.train<-train(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None + FAS_cat_None + hs_contactfam_3cat_num_None + hs_participation_3cat_None, 
...
ps.model.rf<-randomForest(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None + FAS_cat_None + hs_contactfam_3cat_num_None + hs_participation_3cat_None, data=studydata_clean, mtry=3, ntree=500)
...
### LOGIT
```{r, results='hide'}
nn1 <- matchit(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None + FAS_cat_None + hs_contactfam_3cat_num_None + hs_participation_3cat_None, 
...
### RANDOM FOREST
```{r, results='hide'}
nn1.rf <- matchit(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None + FAS_cat_None + hs_contactfam_3cat_num_None + hs_participation_3cat_None, 
...
### ELASTIC NET 
```{r, results='hide'}
nn1.net <- matchit(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None + FAS_cat_None + hs_contactfam_3cat_num_None + hs_participation_3cat_None, 
...
Model                      | Average SMD
-------------------------- | -------------
Original unmatched cohort  | `r toString(ogasmd)`
...
studydata_2 <- studydata_clean %>%
  ...
  mutate(hs_participation_3cat_None = case_when(hs_participation_3cat_None == "None" ~ 1, 
                                                 hs_participation_3cat_None == "1 organisation" ~ 2,
                                                 hs_participation_3cat_None == "2 or more organisations" ~ 2)) %>%
  mutate(hs_contactfam_3cat_num_None = case_when(hs_contactfam_3cat_num_None == "Less than once a week" ~ 1, 
                                               hs_contactfam_3cat_num_None == "Once a week" ~ 2,
                                               hs_contactfam_3cat_num_None == "(almost) Daily" ~ 3)) %>%
  mutate(FAS_cat_None = case_when(FAS_cat_None == "Low" ~ 1, 
                                 FAS_cat_None == "Middle" ~ 2,
                                 FAS_cat_None == "High" ~ 3)) %>%
