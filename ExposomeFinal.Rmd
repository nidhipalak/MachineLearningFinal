...
elastic.train<-train(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None, 
                    data=studydata_clean, method="glmnet", trControl=trainControl("cv", number=10), preProc=c("center", "scale"),
                    tuneGrid=expand.grid(alpha=0.5, lambda=lambda))



ps.model.NET <- glmnet(e3_alcpreg_yn_None ~ h_age_None + hs_wgtgain_None + h_folic_t1_None + h_mbmi_None + e3_sex_None + e3_gac_None, 
                    data=studydata_clean, method="glmnet", trControl=trainControl("cv", number=10), preProc=c("center", "scale"),
